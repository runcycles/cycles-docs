...
| `cycles-spring-ai-starter` | 0.1.0 | 2026-05-12 | Spring Boot 3.5+, Spring AI 1.0+, Java 21 — first public release. Auto-wired `CallAdvisor` + `ChatClientCustomizer` gating every Spring AI `ChatClient.call()` invocation through the Cycles reserve / call / commit / release lifecycle. Companion to `cycles-spring-boot-starter`. | [CHANGELOG](https://github.com/runcycles/cycles-spring-ai-starter/blob/main/CHANGELOG.md) |
